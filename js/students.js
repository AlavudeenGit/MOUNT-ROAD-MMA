      ...
      const [photo_url, aadhar_front_url, aadhar_back_url, license_url] =
        await Promise.all([
          photoFile
            ...
            : Promise.resolve(
                removePhoto ? "" : isEdit ? existing.photo_url : "",
              ),
          frontFile
            ? uploadFile(frontFile, "documents")
            : Promise.resolve(
                removeFront ? "" : isEdit ? existing.aadhar_front_url : "",
              ),
          backFile
            ? uploadFile(backFile, "documents")
            : Promise.resolve(
                removeBack ? "" : isEdit ? existing.aadhar_back_url : "",
              ),
          licenseFile
            ? uploadFile(licenseFile, "documents")
            : Promise.resolve(
                removeLicense ? "" : isEdit ? existing.license_url : "",
              ),
        ]);
